...
// When parsing a configuration value, if the old_value is not understood by this CaribouSlicer version,
// it is being substituted with some default value that this CaribouSlicer could work with.
