...
void PreferencesDialog::build()
{
    ...
    if (is_editor) {
        ...
        append_bool_option(m_optgroup_general, "associate_gcode",
            L("Associate .gcode files to Caribou G-code Viewer"),
            L("If enabled, sets Caribou G-code Viewer as default application to open .gcode files."),
            app_config->get_bool("associate_gcode"));
        append_bool_option(m_optgroup_general, "associate_bgcode",
            L("Associate .bgcode files to Caribou G-code Viewer"),
            L("If enabled, sets Caribou G-code Viewer as default application to open .bgcode files."),
