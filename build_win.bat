...
@REM /|/
@REM /|/ CaribouSlicer is released under the terms of the AGPLv3 or higher
@REM /|/
...
@ECHO  Examples:
@ECHO.
@ECHO  Initial build:           build_win -d "c:\src\CaribouSlicer-deps"
...
SET START_TIME=%TIME%
SET PS_START_DIR=%CD%
SET PS_SOLUTION_NAME=CaribouSlicer
...
IF "%PS_STEPS%" NEQ "app-cmake" msbuild ALL_BUILD.vcxproj /p:Configuration=%PS_CONFIG% /p:CL_AdditionalOptions="/Zm200 %(AdditionalOptions)" /v:quiet %PS_PRIORITY% || GOTO :END
